...
async function Course() {
    ...
    if (payment.payment == "Bank account") {
        ...
        console.log(chalk.bold.italic.blueBright("Kindly submit cash on any physical branch or in our administrative office."));
    }
    return payment;
}
let condition2 = true;
while (condition2 == true) {
    ...
    if (courses.selection == "ALL COURSES") {
        ...
        console.log(chalk.bold.italic.blueBright(`Congratulations! You enrolled on ${input.course} successfully`));
